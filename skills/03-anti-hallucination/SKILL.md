...
name: 反幻觉协议
description: >
  This skill should be used globally. AI反幻觉行为护栏。当AI要断言论文/作者/书名/引用、统计数据/日期/版本号、小众细节、精确API参数时触发。用户说"你确定吗""引用来源""验证一下""不知道也没关系"时也触发。
when_to_use: "always|global|反幻觉|验证|引用|来源|确定吗|API参数"
license: MIT
metadata:
  author: Cuiyi-Srama
  version: 1.0.0
  harness_role: Stop, global
  priority: mandatory
  enforcement: global
---
